...
const ACTION_LABELS: Record<string, string> = {
  ...
  week_manager_override: "Semaine modifiée et validée par le manager",
  ...
  absence_created: "Absence créée (brouillon)",
  absence_created_and_validated: "Absence créée et validée directement",
  absence_submitted: "Absence soumise",
  absence_recalled: "Demande d'absence rappelée",
  absence_validated: "Absence validée",
  absence_needs_changes: "Modification demandée sur une absence",
  absence_updated: "Absence modifiée",
  absence_deleted: "Absence supprimée",
  absence_reopen_requested: "Réouverture d'absence demandée",
  absence_reopen_approved: "Réouverture d'absence acceptée",
  absence_reopen_rejected: "Réouverture d'absence refusée",
  absence_cancellation_requested: "Annulation d'absence demandée",
  absence_cancellation_accepted: "Annulation d'absence acceptée",
  absence_cancellation_rejected: "Demande d'annulation d'absence refusée",
  absence_manager_override: "Absence modifiée et validée par le manager",
  absence_manager_cancelled: "Absence annulée par le manager",
  absence_manager_requested_changes: "Le manager demande une modification d'absence",
